...
- [x] AI business insights (added by the Commerce + POS amendment): sales trend analysis, best sellers, low-stock alerts and simple demand forecasting from the `StockMovement` ledger, using the Phase 4 orchestrator; see `documentation/Phase5_AI_Business_Insights.md`
